...
[Materials]
  ...
  [./eigen_strain]
    ...
    eigen_base = '7.2912e-04 7.3198e-05 -0.0016 0 0 0'
    #eigen_base = '-.0015 0.0007 -0.00035 0 0 0'
  [../]
  [./stress]
...
[Preconditioning]
  [./SMP]
    type = SMP
    coupled_groups = 'phi,chem disp_x,disp_y'
  [../]
[]
...
[Executioner]
  ...
  [./Adaptivity]
    ...
    weight_names = 'phi disp_x disp_y chem'
